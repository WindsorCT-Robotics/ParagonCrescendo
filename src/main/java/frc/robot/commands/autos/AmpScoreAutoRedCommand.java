...
public class AmpScoreAutoRedCommand extends SequentialCommandGroup {
    DriveSubsystem drive;
    ArmSubsystem arm;
    OuttakeSubsystem outtake;

    public AmpScoreAutoRedCommand(DriveSubsystem drive, ArmSubsystem arm, OuttakeSubsystem outtake) {
